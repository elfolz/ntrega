"use strict";(globalThis["webpackChunkNtrega"]=globalThis["webpackChunkNtrega"]||[]).push([[613],{223:(t,e,r)=>{r.d(e,{BH:()=>m,DV:()=>G,GJ:()=>z,L:()=>l,LL:()=>V,P0:()=>A,Pz:()=>w,Sg:()=>I,UI:()=>X,US:()=>c,Wl:()=>M,Yr:()=>T,ZR:()=>k,aH:()=>O,b$:()=>C,cI:()=>j,dS:()=>st,eu:()=>P,g5:()=>i,gK:()=>it,gQ:()=>tt,h$:()=>u,hl:()=>L,hu:()=>o,m9:()=>ct,ne:()=>et,p$:()=>f,pd:()=>Q,q4:()=>y,r3:()=>$,ru:()=>D,tV:()=>d,uI:()=>R,ug:()=>at,vZ:()=>K,w1:()=>B,w9:()=>x,xO:()=>Y,xb:()=>J,z$:()=>N,zd:()=>q});r(2801),r(7658);
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class h extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const u=function(t){const e=s(t);return c.encodeByteArray(e,!0)},l=function(t){return u(t).replace(/\./g,"")},d=function(t){try{return c.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function f(t){return _(void 0,t)}function _(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const r=e;return new Date(r.getTime());case Object:void 0===t&&(t={});break;case Array:t=[];break;default:return e}for(const r in e)e.hasOwnProperty(r)&&p(r)&&(t[r]=_(t[r],e[r]));return t}function p(t){return"__proto__"!==t}
/**
 * @license
 ...
 * limitations under the License.
 */
const U="FirebaseError";class k extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=U,Object.setPrototypeOf(this,k.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,V.prototype.create)}}class V{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},n=`${this.service}/${t}`,o=this.errors[t],i=o?H(o,r):"Error",s=`${this.serviceName}: ${i} (${n}).`,a=new k(n,s,r);return a}}function H(t,e){return t.replace(W,((t,r)=>{const n=e[r];return null!=n?String(n):`<${r}?>`}))}const W=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F=function(t){let e={},r={},n={},o="";try{const i=t.split(".");e=j(d(i[0])||""),r=j(d(i[1])||""),o=i[2],n=r["d"]||{},delete r["d"]}catch(i){}return{header:e,claims:r,data:n,signature:o}},x=function(t){const e=F(t),r=e.claims;return!!r&&"object"===typeof r&&r.hasOwnProperty("iat")},z=function(t){const e=F(t).claims;return"object"===typeof e&&!0===e["admin"]};
/**
 * @license
 * Copyright 2017 Google LLC
 *
